...
function GetBonusText( playerID:number, envoyTokenNum:number )
	...
	elseif (leader == "LEADER_MINOR_CIV_MARITIME" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_MARITIME") then
		if envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FIRST_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_MARITIME_TRAIT_SMALL_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_SECOND_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_THIRD_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS");
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	elseif (leader == "LEADER_MINOR_CIV_AGRICULTURAL" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_AGRICULTURAL") then
		if envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FIRST_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_AGRICULTURAL_TRAIT_SMALL_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_SECOND_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_AGRICULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_THIRD_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_AGRICULTURAL_TRAIT_LARGE_INFLUENCE_BONUS");
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	else
...
function GetBonusIconAtlasPieces( kCityState:table, size:number )			
	...
	elseif kCityState.Type == "MARITIME"		then	iconName = "ICON_ENVOY_BONUS_MARITIME";	
	elseif kCityState.Type == "AGRICULTURAL"	then	iconName = "ICON_ENVOY_BONUS_FOOD";		
	end
...
function GetTypeTooltip( kCityState:table )
	...
	elseif kCityState.Type == "MARITIME"		then	toolTip	 = "LOC_CITY_STATES_TYPE_MARITIME";
	elseif kCityState.Type == "AGRICULTURAL"	then	toolTip	 = "LOC_CITY_STATES_TYPE_AGRICULTURAL";
	else
...
function GetTypeAtlasPieces( kCityState:table, size:number )
	...
	elseif kCityState.Type == "MARITIME"		then	iconName = "ICON_CITYSTATE_MARITIME";	
	elseif kCityState.Type == "AGRICULTURAL"	then	iconName = "ICON_CITYSTATE_AGRICULTURAL";			
	else
...
function GetTypeName( kCityState:table )			
	...
	elseif kCityState.Type == "MARITIME"		then	return Locale.Lookup("LOC_CITY_STATES_TYPE_MARITIME");
	elseif kCityState.Type == "AGRICULTURAL"	then	return Locale.Lookup("LOC_CITY_STATES_TYPE_AGRICULTURAL");
	end
