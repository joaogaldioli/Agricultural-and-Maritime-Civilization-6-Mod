...
PageLayouts["CityState" ] = function(page)
	...
	local types = {
		...
		["LEADER_MINOR_CIV_MARITIME"] = {"ICON_CITYSTATE_MARITIME", "LOC_CITY_STATES_TYPE_MARITIME", "COLOR_PLAYER_CITY_STATE_MARITIME_SECONDARY"},
		["LEADER_MINOR_CIV_AGRICULTURAL"] = {"ICON_CITYSTATE_AGRICULTURAL", "LOC_CITY_STATES_TYPE_AGRICULTURAL", "COLOR_PLAYER_CITY_STATE_AGRICULTURAL_SECONDARY"},
	}
